...
export const CarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M11 17H6.538C5.043 17 4.192 15.667 4.52 14.255L5.92 8.255A2.5 2.5 0 018.344 6h7.312a2.5 2.5 0 012.424 2.255l1.4 6c.328 1.412-.523 2.745-2.018 2.745H13" />
  </svg>
);
...
export const SyncIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 4a15.042 15.042 0 0115.042 15.042m-5.042-15.042A15.042 15.042 0 004.958 4.958" />
    </svg>
);
